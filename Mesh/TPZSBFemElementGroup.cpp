...
void TPZSBFemElementGroup::CalcStiffBlaze(TPZElementMatrix &ek,TPZElementMatrix &ef)
{
    ...
    blaze::DynamicVector<complex<double>,blaze::columnVector> eigvalblaze( 2*n );       // The vector for the real eigenvalues
	blaze::DynamicMatrix<complex<double>,blaze::columnMajor> eigvecblaze( 2*n, 2*n );  // The matrix for the left eigenvectors
